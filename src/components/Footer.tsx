...
const Footer = () => {
    return (
        <footer className="bg-primary mt-20 flex flex-col items-center text-foreground  py-10">
            <div className="container  max-w-5xl flex flex-col lg:flex-row justify-between px-10 lg:px-10 lg:items-start">
                {/* Left Section */}
                <div className="flex flex-col   space-y-4">
                    <h3 className="text-base lg:text-xl font-semibold">The Fellowship App</h3>
                    ...
                    {/* policies secton */}
                    <div className="flex gap-2 text-sm md:text-base flex-col lg:flex-row text-foreground  mt-6">
                ...
                <div className="flex flex-col  items-start mt-10 lg:mt-0">
                    ...
                    <p className="text-sm md:text-base mb-2 text-foreground">Join our newsletter to stay up to never miss our latest releases</p>
            ...
            <div className="mt-10 text-center text-sm md:text-base  text-foreground">
